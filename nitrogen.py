...
class NitroGen: 
    ...
    def main(self):
        ...
        if os.name == "nt": 
            print("")
            ctypes.windll.kernel32.SetConsoleTitleW("Nitro Gen & Checker by Ashton#0420") 
        else: 
            print(f'\33]0;Nitro Gen & Checker by Ashton#0420\a', end='', flush=True) 

        print("""Created by Ashton#0420""")
        time.sleep(2)
        ...
        for i in range(num):
            ...
            if os.name == "nt": 
                ctypes.windll.kernel32.SetConsoleTitleW(f"Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - by Ashton#0420") 
                print("")
            else:
                print(f'\33]0;Nitro Generator and Checker - {len(valid)} Valid | {invalid} Invalid - by Ashton#0420\a', end='', flush=True) 
